...
int quantidade_Nfolhas(NoArv *raiz){
    if(raiz == NULL)
        return 0;
    else if(raiz->esquerda == NULL && raiz->direita == NULL)
        return 0;
  return 1+quantidade_Nfolhas(raiz->esquerda) + quantidade_Nfolhas(raiz->direita);        
}
...
int main(){
    ...
    do{
        ...
        case 5:
            ...
            break;
          case 6:
            printf("\n\tQuantidade nós nao folhas: %d\n", quantidade_Nfolhas(raiz));
            break;
          case 7:
